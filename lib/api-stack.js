...
export class APIStack extends cdk.Stack {
    constructor(scope, id, dbStack, props,MyCdkStack) {
        super(scope, id, props);
        // Lambda function to return a pre-signed URL
        
         // Access the existing bucket from the cdk app Stack
        const uploadBucket = MyCdkStack.TransactionUploadsBucket;
        this.GetUploadUrlLambda = new lambda.Function(this, "GetUploadUrlLambda", {
        ...
        const api = new apigateway.RestApi(this, "SensAI Api", {
